...
function App() {
  ...
  return React.createElement("div", { className: `store ${theme}` },
    ...
    route.page === "product" && React.createElement(ProductPage, { product: activeProduct, products, settings, addToCart, navigate }),
...
function Footer({ settings }) {
  ...
  const departmentLinks = Array.isArray(settings.department_links) ? settings.department_links : [{ label: "Shirts", href: "#/shop" }, { label: "Accessories", href: "#/shop" }, { label: "Admin Login", href: "/admin.html" }];
